...
import Logo1 from "./pages/page/Logo";
...
function App() {
  return (
    <main className="grid wide container">
      <div className="row">
        <div className="col l-12 m-12 c-12">
          <header>
            <div className="row">
              <div className="col l-4 c-2">
              ...
              <div className="col l-4 c-7 non-padding">
      ...
      <div className="row no-gutters">
        ...
        <div className="col l-7 c-12">
          <div className="side-2">
            <div className="row">
              <h1 className="l-2">None</h1>
              <h1
                className="l-8"
                style={{ backgroundColor: "#242526", borderRadius: "20px" }}
              >
                Content
              </h1>
              <h1 className="l-2">None</h1>
        ...
        <div className="col l-3 c-0">
          <div className="side-3">
            <h4 className="padding-top">Được Tài Trợ</h4>
            <div className="banner1">
              <ul>
                <li>
                  <img src={baner1} alt="" />
                  <p>Tải xuống phiên bản PC ngay bây giờ</p>
                  <a href="/">dauladailuc.com</a>
                </li>
                <li></li>
              </ul>
            </div>
